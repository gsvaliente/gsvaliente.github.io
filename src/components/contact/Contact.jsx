        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            ...
            <div className="contact__card">
              ...
              <a href="mailto:gsvalient@gmail.com" className="contact__button">
                write here
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">999999999</span>
        ...
        <div className="contact__content">
          ...
          <form className="contact__form">
            ...
            <div className="contact__form-div container__form-area">
              <label className="contact__form-tag">More Info</label>
              <textarea
                name="project"
                cols="30"
                rows="10"
